package lolo.effects.float
{
	...
	/**
	 * <b>向上浮动效果</b></br>
	 * - step1: 从 alpha=0 到 alpha=1 ，并向下浮动目标</br>
	 * - step2: 向上浮动目标</br>
	 * - step3: 停留指定时间后，再向上浮动目标，并将 alpha 设置为0</br>
	 * - step4: 浮动结束后，将目标从父容器中移除，并将 alpha 设置为1
	 * @author LOLO
	 */
	public class UpFloat implements IFloat
	{
		/**应用该效果的目标*/
		 ...
		 */
		public function UpFloat(target:DisplayObject=null, onComplete:Function=null)
		{
			this.target = target;
